...
public class TileEntityBlastFurnace extends TileEntity implements ISidedInventory
{
    ...
    private ItemStack[] blastFurnaceItemStacks = new ItemStack[3];
    ...
    {
        return this.blastFurnaceItemStacks[slot];
    }
    ...
    {
        if (this.blastFurnaceItemStacks[var1] != null)
        {
            ItemStack itemstack;

            if (this.blastFurnaceItemStacks[var1].stackSize <= var2)
            {
                itemstack = this.blastFurnaceItemStacks[var1];
                this.blastFurnaceItemStacks[var1] = null;
                return itemstack;
            }
            else
            {
                itemstack = this.blastFurnaceItemStacks[var1].splitStack(var2);

                if (this.blastFurnaceItemStacks[var1].stackSize == 0)
                {
                    this.blastFurnaceItemStacks[var1] = null;
                }
    ...
    {
        if (this.blastFurnaceItemStacks[slot] != null)
        {
            ItemStack itemstack = this.blastFurnaceItemStacks[slot];
            this.blastFurnaceItemStacks[slot] = null;
            return itemstack;
        }
        else
        {
    ...
    {
        this.blastFurnaceItemStacks[slot] = itemstack;
    ...
    public void readFromNBT(NBTTagCompound tagCompound)
    {
        ...
        for (int i = 0; i < taglist.tagCount(); ++i)
        {
            ...
            if (b0 >= 0 && b0 < this.blastFurnaceItemStacks.length)
            {
                this.blastFurnaceItemStacks[b0] = ItemStack.loadItemStackFromNBT(tagcompound1);
            }
        }

        this.furnaceBurnTime = tagCompound.getShort("BurnTime");
        this.furnaceCookTime = tagCompound.getShort("CookTime");
        this.currentBurnTime = getItemBurnTime(this.blastFurnaceItemStacks[1]);
    ...
    public void writeToNBT(NBTTagCompound tagCompound)
    {
        ...
        for (int i = 0; i < this.blastFurnaceItemStacks.length; ++i)
        {
            if (this.blastFurnaceItemStacks[i] != null)
            {
                ...
                this.blastFurnaceItemStacks[i].writeToNBT(nbttagcompound1);
    ...
    public void updateEntity()
    {
        ...
        {
            if (this.furnaceBurnTime != 0 || this.blastFurnaceItemStacks[1] != null && this.blastFurnaceItemStacks[0] != null)
            {
                if (this.furnaceBurnTime == 0 && this.canSmelt())
                {
                    this.currentBurnTime = this.furnaceBurnTime = getItemBurnTime(this.blastFurnaceItemStacks[1]);
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = BlastFurnaceRecipes.smelting().getSmeltingResult(this.blastFurnaceItemStacks[0]);
